...
// use strings.Splits to break path into segments to get {action} param and {provider} param
// switch case action = "login", print something to the screen, otherwise, write out the error with StatusNotFound
